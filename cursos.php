...
$total_sql = $con->prepare("SELECT COUNT(*) FROM cursos WHERE nombre LIKE :search");
            ...
            <div class="card h-100 d-flex flex-column">
                ...
                <div class="card-footer bg-transparent border-0 mt-auto">
                    <div class="text-center">
                        <a href="curso.php?id_curso=<?php echo $curso["id"]?>" class="btn btn-primary">Más Información</a>
                    </div>
                </div>
            </div>
        </div>  
