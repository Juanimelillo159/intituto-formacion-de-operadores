...
<body>
    <div class="jumbotron jumbotron-fluid py-5 text-white">
        <div class="container">
            <a id="back" href="index.php" class="text-white mb-3 d-inline-flex align-items-center" style="text-decoration:none;">
                <button>
            ...
            <h1 class="display-4"><?php echo $curso["nombre_curso"] ?></h1>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-8 text-white">
                <h2 class="display-2 ">Descripción del Curso</h2>
