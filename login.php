...
$page_title = "Login | Instituto de Formaci贸n";
$page_description = "Pagina de inicio de sesi贸n del Instituto de Formaci贸n de Operadores";
        ...
        <div class="container">
            <div class="login-container">
                <div class="login-logo">
                    <img src="logos/LOGO PNG_Mesa de trabajo 1.png" alt="Instituto de Formaci贸n de Operadores">
                </div>
                ...
                <form method="POST" action="admin/sesion.php" id="form-login">
                    ...
                    <button type="submit" name="iniciar_sesion" class="btn btn-primary w-100">Iniciar sesi贸n</button>
                    <div class="text-center mt-2">
                        <a href="recuperar.php">縊lvidaste tu contrase馻?</a>
                    </div>
                    <p class="text-center mt-3">縉o tienes cuenta? <a href="registro.php">Crear cuenta</a></p>
                </form>
        ...
        (function () {
            ...
            var showModal = function (type, message, title) {
                ...
                switch (type) {
                    ...
                    case 'danger':
                        icon = 'error';
                        defaultTitle = 'No pudimos completar la acci贸n';
                        break;
                    case 'warning':
                        icon = 'warning';
            ...
            document.addEventListener('click', function (event) {
                ...
                if (!email) {
                    showModal('error', 'Ingresa tu correo para reenviar la verificaci贸n.', 'Falta correo');
                    if (emailInput) {
                        emailInput.focus();
                    }
                    return;
